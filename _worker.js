...
// Variables
const rootDomain = "ayeuna.workers.dev"; // Ganti dengan domain utama kalian
const serviceName = "xray-gratisan"; // Ganti dengan nama workers kalian
const apiKey = ""; // Ganti dengan Global API key kalian (https://dash.cloudflare.com/profile/api-tokens)
const apiEmail = "marifsmlbb11022002@gmail.com"; // Ganti dengan email yang kalian gunakan
